...
import catalogue.BetterBasket; // Update this to import BetterBasket
...
public class CashierModel extends Observable
{
    ...
    private BetterBasket    theBasket  = null;            // Bought items (changed to BetterBasket)
     ...
     * @return an instance of a new BetterBasket
     */
    protected BetterBasket makeBasket() // Changed to BetterBasket
    {
        return new BetterBasket(); // Now returns a BetterBasket instance
    }
    
    // Sort method for the sort button
	...
	public void doSort()
    {
        if (theBasket != null) {
        	theBasket.sortID();
        	setChanged();
            notifyObservers("Sorted items by ID (descending)");
        }
    }
}
